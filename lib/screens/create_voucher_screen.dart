...
class _CreateVoucherScreenState extends State<CreateVoucherScreen> {
  ...
  void initState() {
    ...
    _amountController.addListener(() {
      ...
      setState(() {
        _feeAmount = val * 0.03; // ✨ 3% Voucher Creation Fee
        _totalCost = val + _feeAmount;
      });
    });
  }
  ...
  void _handleCreateVoucher() async {
    ...
    final response = await WalletService.createVoucher(
      amount: amount,
    ...
    if (response['success'] == true) {
      _showVoucherSuccessDialog(response['code'], amount);
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
  ...
  void _showVoucherSuccessDialog(String code, double amount) {
    showDialog(
      context: context,
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: const Column(
            children: [
              Icon(Icons.card_giftcard, color: Colors.cyanAccent, size: 50),
              SizedBox(height: 10),
              Text(
                'VOUCHER CREATED!',
                style: TextStyle(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text(
                'Copy and share this code. Anyone can redeem it!',
                textAlign: TextAlign.center,
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: _isLoading ? null : _handleCreateVoucher,
                  child: _isLoading
